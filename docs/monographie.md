...
Ces méthodes sont désignées par le terme <em>Big Data</em>.
...
![WBS](https://github.com/prodageo/mniproj2020b-2020a30a/blob/master/docs/img/WBS.png)
...
https://medium.com/@OpcitoTechnologies/building-a-real-time-data-pipeline-using-spark-streaming-and-kafka-a603495c4213, Tuto for real-time data analytic with Spark *consulté le : 08/12/2020*
